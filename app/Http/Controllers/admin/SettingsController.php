...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/settings')->with('success','Your profile has been changed successfully!');
    }
    ...
    public function index()
    {
        ...
        return view('admin.settings')->with(['notification'=> $notification, 'social_facebook' => $social_facebook,
