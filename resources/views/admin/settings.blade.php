                            ...
                            <div class=" profile-top-area">
                                <div class="col-md-2">
                                    ...
                                    @if( isset(Auth::user()->image) && !empty(Auth::user()->image) && Auth::user()->image != "")
                                        <img src="{{ url( Config::get('app.avatars_url') )}}/{{Auth::user()->image}}" width="130" height="130">
                                    @else
                                        <img src="{{ url( Config::get('app.avatars_url').'default-avatar.png')}}" width="130" height="130">
                                    @endif
                                ...
                                <!--<div class="col-md-10">
                                          <h4>Upload avator</h4>
                                          <div class="input-group">
                                            <input type="file" class="" placeholder="Select file" name="avator">
                                          </div>
                                </div>-->
                            </div>
