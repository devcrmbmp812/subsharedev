                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{url('assets/admin/img/Line%20chart.png')}}" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="table1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <div class="table-scrollable">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img src="{{url('assets/admin/img/joe.png')}}"><span>Joe Miller</span> </td>
                                                        <td>$345</td>
                                                        <td>45</td>
                                                        <td>224</td>
                                                        <td>80%</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{url('assets/admin/imgimg/joe.png')}}"><span>Joe Miller</span> </td>
                                                        <td>$345</td>
                                                        <td>45</td>
                                                        <td>224</td>
                                                        <td>80%</td>
            ...
            <div class="col-md-3 center-area">
                <div class="grey-area">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <ul class="grey-right">
                                <li><img src="{{url('assets/admin/imgimg/arrow-up.png')}}"><span>4%</span></li>
                                <li class="second-list"><img src="{{url('assets/admin/img/down-arrow.png')}}"><span>7%</span></li>
                                <li><img src="{{url('assets/admin/imgimg/arrow-up.png')}}"><span>2%</span></li>
                            </ul>
                ...
                <div class="white-small-tabs">
                    <h3>765</h3><div class="icon-graph"> <img src="{{url('assets/admin/img/graph-icon.png')}}"></div>
                    <div class="progress">
                ...
                <div class="white-small-tabs">
                    <h3>23</h3><div class="icon-graph"> <img src="{{url('assets/admin/img/responses.png')}}"></div>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:45%">
                        </div>
                    </div>
                ...
                <div class="graph-grow">
                    <img src="{{url('assets/admin/img/graph-grow.png')}}" class="img-responsive">
                </div>
            </div>
            <!-- col-md-3-end -->
            <div class="col-md-3 last-sales">
                ...
                <div class="grey-area">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <ul class="grey-right">
                                <li><img src="{{url('assets/admin/img/arrow-up.png')}}"><span>4%</span></li>
                                <li class="second-list"><img src="{{url('assets/admin/img/down-arrow.png')}}"><span>7%</span></li>
                                <li><img src="{{url('assets/admin/img/arrow-up.png')}}"><span>2%</span></li>
                            </ul>
