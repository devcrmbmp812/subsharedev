...
<section class="content">
    <div class="row">
        <div class="col-lg-12 top-right-content">
            {{ Form::open(array('url' => '/admin/roles/search', 'method' => 'POST')) }}
                {{ csrf_field() }}
        ...
        <div class="row tab-heading-table">
            <div class="inner-table-tab-heading">
                ...
                <div class="col-md-2 pull-right">
                    <a class="btn btn-info load_music" href="{{url('admin/roles/create')}}">Add Role</a>
                </div>
            </div>
        </div>
        <!-- top tabs ends -->
            ...
            <div class="panel-body table-responsive">
                <div id="table1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                    <table class="table table-striped table-bordered dataTable no-footer" id="table1" role="grid" aria-describedby="table1_info">
                        <thead>
                        <tr role="row">
                            <th class="sorting_asc" tabindex="0" aria-controls="table1" rowspan="1" colspan="1"   aria-label="" style="width: 188px;">ID  </th>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <div class="last-table-area">
                                    <a class="btn btn-info load_music" href="{{url('admin/roles/'.$post->id)}}"><p>View Details</p></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
