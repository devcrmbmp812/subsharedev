                                    ...
                                    <div class="panel-footer">
                                        <div class="row">
                                            <div class="col-md-12" style="">
                                                <a class="btn btn-default btn-lg" href="{{url('admin/roles/'.$post->id.'/edit')}}">Edit</a>

                                                {!! Form::open(['action'=>['admin\SubshareRolesController@destroy',$post->id],'method'=>'POST','class'=>' ' ]) !!}
