        ...
        <div class="form-group row">
            ...
            <script>
                ...
                var updateLabel = function (region) {
                    ...
                    var label = $('#tag-name'+region.id+' .form-control').val();
