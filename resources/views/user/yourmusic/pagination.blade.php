                            ...
                            @if( count($media) > 0 )
                               ...
                               <div class="table-top">
                                <div class="dataTables_info" id="table1_info" role="status" aria-live="polite">{{ count($allmedia) }} results
                                  <button type="button" class="btn btn-default btn-sm" onClick='window.location.replace("{{ url('/your-music') }}");'> <span class="glyphicon glyphicon-filter"></span>Clear Filter</button>
                                </div>
