                                                        ...
                                                        @foreach($AllTransactions as $transaction)
                                                                ...
                                                                <tr role="row" class="even">
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      <a target="_blank" href="{{url('/downloadPDF')}}/{{$transaction->id}}"><img src="assets/img/pdf.png"></a>
                                                        ...
                                                        @foreach($PendingTransactions as $pendingTransaction)
                                                                ...
                                                                <tr role="row" class="even">
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <a target="_blank" href="{{url('/downloadPDF')}}/{{$pendingTransaction->id}}"><img src="assets/img/pdf.png"></a>
                                                        ...
                                                        @foreach($invoices as $invoice)
                                                                ...
                                                                <tr role="row" class="even">
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <a target="_blank" href="{{url('/downloadPDF')}}/{{$invoice->id}}"><img src="assets/img/pdf.png"></a>
