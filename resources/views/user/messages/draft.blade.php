...
<aside class="right-side">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-angle-right" aria-hidden="true"></i>Draft Messages</li>
    </ol>
                                ...
                                @foreach($draft_messages as $message)
                                    <tr id="msg3" class="unread">
                                        ...
                                        <td class="inbox-data-from hidden-xs hidden-sm">
                                            <a href="{{ url('messages/read/') }}/{{ $message->id }}">{{ \Helpers::getUserFullName($message->toUser) }}</a>
                                        </td>
