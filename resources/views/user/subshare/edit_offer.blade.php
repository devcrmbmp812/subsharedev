        ...
        <div class="breadcrumb feed-crumbs">
            <ol>
                <li><a href="{{ url('/user-dashboard') }}">Dashboard</a></li>
                 ...
                 <li class="active"><i class="fa fa-angle-right" aria-hidden="true"></i><a href="javascript:void">Edit</a></li>
            </ol>
        </div>
                ...
                <div class="col-md-6">
                        ...
                        <div class="creation-area">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="sel1" name="percentage">
                                    @for ($i = 1; $i <= 100; $i++)
                                         <option value="{{ $i }}%" {{ ( $offer->percentage == $i.'%' )? 'selected' : ''}}>{{ $i }}%</option>
                                    @endfor
                                </select>
                            </div>
                            <div class="form-group">
                            <textarea  class="form-control" rows="5" id="com" placeholder="Custom agreement" name="agreement" style="resize: none">{{ trim($offer->custom_agreement) }}</textarea>
                        </div>
                        </div>

                        <input type='hidden' name="track_id" value="{{ Request::segment(3) }}">
      		            <input type='hidden' name="offer_id" value="{{ Request::segment(3) }}">
                    ...
                    <div class="creation-area sub_two">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="radio" value="1" id="test1" name="myradio" {{ ( $offer->type == 1 )? 'checked' : '' }}>
                                <label for="test1" id="text1">I want to give you all my media the way it is constructed</label>
							</div>

							<div class="form-group">
                                <input type="radio" value="2" id="test2" name="myradio" {{ ( $offer->type == 2 )? 'checked' : '' }}>
                            ...
                            <div id="form_section2" class="common-class">
                                <div class="form-group extra_pad">
                                    <textarea class="form-control" rows="5" name="com2" placeholder="Which Section?">{{ ( $offer->type == 2 )? $offer->tsection : '' }}</textarea>
                                </div>
                                <div class="form-group extra_pad">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="amount2" placeholder="Fixed amount" value="{{ ( $offer->type == 2 )? $offer->tamount : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="percentage2" placeholder="Percent share" value="{{ ( $offer->type == 2 )? $offer->tpercentage : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <input type="radio" value="3" id="test3" name="myradio" {{ ( $offer->type == 3 )? 'checked' : '' }}>
                            ...
                            <div id="form_section3" class="common-class" style="display:none;">
                                <div class="form-group extra_pad">
                                    <textarea class="form-control" rows="5" name="com3" placeholder="Which Component?">{{ ( $offer->type == 3 )? $offer->tsection : '' }}</textarea>
                                </div>
                                <div class="form-group extra_pad">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="amount3" placeholder="Fixed amount" value="{{ ( $offer->type == 3 )? $offer->tamount : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="percentage3" placeholder="Percent share" value="{{ ( $offer->type == 3 )? $offer->tpercentage : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <input type="radio" value="4" id="test4" name="myradio" {{ ( $offer->type == 4 )? 'checked' : '' }}>
                            ...
                            <div id="form_section4" class="common-class" style="display:none;">
                                ...
                                <div class="form-group extra_pad">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" name="amount4" class="form-control" placeholder="Fixed amount" value="{{ ( $offer->type == 4 )? $offer->tamount : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button type="sbumit" class="btn btn-default" data-dismiss="modal">UPDATE</button>
                                ...
                                <div class="inner-feed-area">
                                 <ul>
                                    @if( count($offers) > 0 )
                                        ...
                                        @endforeach
                                    @else
                                         <li class="feed-details">No Offer Found.</li>
                                    @endif
                                 </ul>
                                </div>
                            </div>
                                ...
                                <div class="inner-feed-area">
                                    <ul>
                                        @if( count($responses) > 0 )
                                             ...
                                             @endforeach
                                        @else
                                             <li class="feed-details">No Responses Found.</li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
    if ( $('#test1').is(':checked') )
    {
            $("#form_section1").css("display","block");

            $("#form_section2").css("display","none");
            $("#form_section3").css("display","none");

    } else if($('#test2').is(':checked')) {

            $("#form_section2").css("display","block");
            $("#form_section3").css("display","none");

    } else if($('#test3').is(':checked')) {

            $("#form_section3").css("display","block");
            $("#form_section2").css("display","none");

    } else if($('#test4').is(':checked')) {

            $("#form_section4").css("display","block"); // display section 4.
...
<!-- not using below js -->
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.21.0/js/jquery.fileupload.min.js"></script>
