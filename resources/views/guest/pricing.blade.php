...
@section('title', 'Pricing | Subshare')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="pricing-tab-area">
                        ...
                        <button type="button" class="join-us-btn btn btn-default">Join</button>
                ...
                <div class="col-md-4">
                    ...
                    <div class="pricing-tab-area medium-area">
                        ...
                        <button type="button" class="join-us-btn btn btn-default btn_mid">Join</button>
